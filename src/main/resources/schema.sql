...
DROP TABLE IF EXISTS relationship; --добавил удаление таблицы перед запуском
DROP TABLE IF EXISTS user_filmorate; --добавил удаление таблицы перед запуском
...
CREATE TABLE IF NOT EXISTS film_genre(id_film INTEGER REFERENCES film (film_id) ON delete CASCADE, genre_id INTEGER REFERENCES genre(id) ON delete CASCADE);
...
CREATE TABLE IF NOT EXISTS film_likes(id_film INTEGER REFERENCES film(film_id) ON delete CASCADE, id_user INTEGER REFERENCES user_filmorate(user_id) ON delete CASCADE);
CREATE TABLE IF NOT EXISTS relationship(id INTEGER REFERENCES user_filmorate(user_id) ON delete CASCADE, id_friend INTEGER REFERENCES user_filmorate(user_id) ON delete CASCADE);
